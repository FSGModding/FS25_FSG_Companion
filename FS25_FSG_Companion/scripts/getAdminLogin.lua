...
function GetAdminLogin.new(mission, i18n, modDirectory, modName)
  -- print("GAE-new")
  local self = setmetatable({}, GetAdminLogin_mt)
...
function GetAdminLogin.userNowAdminEvent(user)
	if g_server ~= nil and g_currentMission ~= nil then
		...
		-- DebugUtil.printTableRecursively(allMasterUsers, "*** FSG Realism Companion Debug *** allMasterUsers : ", 0, 1)
